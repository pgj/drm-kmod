...
#define IS_PSB(dev) (((dev)->device & 0xfffe) == 0x8108)
#define IS_MRST(dev) (((dev)->device & 0xfff0) == 0x4100)
#define IS_MFLD(dev) (((dev)->device & 0xfff8) == 0x0130)
#define IS_CDV(dev) (((dev)->device & 0xfff0) == 0x0be0)
